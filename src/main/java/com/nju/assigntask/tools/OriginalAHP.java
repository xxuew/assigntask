...
public class OriginalAHP {
    ...
    {
        OriginalAHP ct=new OriginalAHP();
        OriginalAHP ct1=new OriginalAHP();
        OriginalAHP ct2=new OriginalAHP();
        OriginalAHP ct3=new OriginalAHP();
        //目标层比较矩阵
