...
import com.nju.assigntask.dao.MyreceiveMapper;
...
public class MyreceivedServiceImpl implements MyReceiveService {
     ...
     */
    @Override
    public Myreceive selectByUser(int userid,int myReceiveId) {
       return myreceiveMapper.selectByIDs(userid,myReceiveId);
